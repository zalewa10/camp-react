    ...
    <section className="max-container padding-container flex flex-col gap-20 py-20 pb-32 md:gap-28  xl:flex-row">
      ...
      <div className="relative z-20 flex flex-1 flex-col xl:w-1/2">
        ...
        <p className="regular-16 mt-6 text-gray-30 xl:max-w-[520px]">
          ...
          vero numquam repellat nemo eum doloribus quos id labore iure impedit
          molestiae illo asperiores, quo cumque laboriosam, porro quisquam
          error?
        </p>
        ...
        <div className="relative z-20 w-[268px] flex flex-col gap-8 rounded-3xl bg-green-90 px-7 py-8">
          ...
          <div className="flexBetween">
            <div className="flex flex-col">
              ...
              <p className="bold-20 text-white">172.28 km</p>
            </div>
            <div className="flex flex-col">
